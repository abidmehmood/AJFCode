...
public class Trace {
	...
	/**
	 * Prints an "exiting" message. It is intended to be called in the end of
	 * the blocks to be traced.
	 */
	...
	public static void printEntering(String str) {
		printIndent();
		stream.println("--> " + str);
	}

	public static void printExiting(String str) {
		printIndent();
		stream.println("<-- " + str);
	}
